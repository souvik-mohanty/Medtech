...
import com.company.medtech.auth.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                // API is stateless and token-based — no CSRF, no form login, no basic popup, no HTTP session
                ...
                // ✅ Allow the web/mobile clients to call the API cross-origin
