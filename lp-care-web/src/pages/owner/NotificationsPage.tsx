...
import { getOwnerNotifications, markAllOwnerNotificationsRead, markOwnerNotificationRead } from "@/services/api/notificationsApi"
...
export function OwnerNotificationsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Notifications"
        description="New bookings, orders, and payments for your laboratory."
        actions={
          unreadCount > 0 ? (
