...
export function LoginPage() {
  const { token, role, error, loginWithGoogleIdToken } = useAuth();
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        <h1 style={styles.title}>MedTech</h1>
        <p style={styles.subtitle}>Sign in to order medicine or manage your shop</p>
